...
//we store Anonymus fucntion is some varible
...
//getAttribute
console.log("__________getAttribute_____________");
...
console.log("*****ADVANCE array methods in javascript*****");
console.log("_____________________________________________");
...
const result_every = arr.every((value,index)=>{
    ...
    return value<20 // true : if all the values are smaller then 20 in arr
});
